...
///////////////////////////////////////////////////////////////////////////
// Setting 버튼을 누를때 UI 처리
//  의존: setting_close()
//        change_setbutton_color()
///////////////////////////////////////////////////////////////////////////
function setting_things(x){
	
	var div = document.getElementById('device_setting');
	if(div){
		document.getElementById("device_setting").style.display = "block"
	}else{
...
function setting_close(){
	...
	document.getElementById("device_setting").style.display = "none"
...
// Things 테이블에서 특정 Things 항목을 선택할 때 호출
